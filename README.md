# BERT Text Classifier from HuggingFace (BertForSequenceClassification)

BERT Text Classifier for the text classification problem category as per Ready Tensor specifications.
...
- A **BERT Text Classifier** algorithm built using **transformers** package.
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the BERT classifier model implemented using **transformers** python package.
